...
def do_it():
    ...
    dist_dir = pathlib.Path("dist/AutomataDefense_{}_{}".format(
    ...
    dist_dir_subdir = pathlib.Path("{}/AutomataDefense".format(dist_dir))
    ...
    if os_system_str == _LINUX:
        ...
        exe_path = pathlib.Path("{}/AutomataDefense".format(dist_dir_subdir))
